                    ...
                    <div class="contact-location-card d-flex justify-content-between flex-wrap">
                            ...
                            <div class="left d-flex flex-wrap">
                                ...
                                <div class="contact-location-card-details">
                                    ...
                                    <div class="d-flex  buttonGroup p-0 w-100">
                                        <a class=" btn theme-btn theme-bg" href="{{$contact->map}}">
                                            View Map</a>
                                        <a class=" btn theme-btn theme-border" href="https://wa.me/{{$contact->whatsapp_number ?? $siteInformation->whatsapp_number}}">
                            ...
                            <div class="right d-flex flex-wrap ">
                                ...
                                <div class="contact-location-contact-info">
                                    ...
                                    <a href="tel:{{$contact->alternate_phone_number}}">{{$contact->alternate_phone_number}}</a>
            ...
            <div class="contact-form">
                ...
                <form action="#" id="contactPageForm">
                    <div class="d-flex flex-wrap justify-content-between">
                        ...
                        <span id="name_Error" class="error-message">Please enter your name</span>
                    </div>
                    <div class="formGroup w-100">
                    ...
                    <div class="formGroup w-100">
                        <input type="tel" name="phone" id="phone" class="phone_number" placeholder="Phone">
                        <span id="phone_Error" class="error-message">Please enter a valid phone number</span>
                    </div>
            
                    <div class="formGroup w-100">
                        <textarea id="message" name="message" rows="" cols="" placeholder="Message"></textarea>
                        <span id="message_Error" class="error-message">Please enter your message</span>
                    </div>
                    <div class="d-flex buttonGroup p-0 w-100">
                        <button type="submit" class=" btn theme-btn theme-bg" data-url="/contact" id="contact_form_btn"> Send a message</button>  
                    </div>
                    </div>  
                </form>
            </div>
