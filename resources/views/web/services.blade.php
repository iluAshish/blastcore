        ...
        <div class="d-flex flex-wrap justify-content-between">
                ...
                <article>
                    @foreach($services as $service)
                        <a href="{{ route('serviceDetail', ['short_url' => $service->short_url]) }}"  class="services-list-card">
                            <picture>
                                <img src="{{ asset('uploads/service/webp/' .rawurlencode($service->webp_image)) }}" width="371" height="264" class="img-fluid" alt="{{$service->image_meta_tag}}">
                            </picture>
