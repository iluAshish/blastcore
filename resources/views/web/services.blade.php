...
<section class="services-list commonPadding-120">
    <div class="container-services">
        <div class="d-flex flex-wrap justify-content-between">
                ...
                <article>
                    <a href="{{ route('serviceDetail', ['short_url' => 'heater']) }}"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/1.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                        <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                                    <p>We are specialist in Foundry works in Cast iron, Brass, Bronze and...</p>
                            </div>
                            <button class="load-more w-fit mt-auto d-flex align-items-center">
                            Read More 
                    ...
                    <a href="{{ route('serviceDetail', ['short_url' => 'heater']) }}"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/2.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                            <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/3.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                                <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/4.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                            <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/5.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                            <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/6.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                                <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/7.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                                <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/8.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                                <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/9.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                            <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/10.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                        <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/11.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                            <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/12.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                                <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
                    ...
                    <a href="services-detail.php"  class="services-list-card">
                        <picture>
                            <img src="{{asset('web/images/services/13.jpg')}}" width="371" height="264" class="img-fluid" alt="Foundry">
                        </picture>
                                <div class="services-list-card-details">
                            <div>
                                    <h3>Foundry</h3>
