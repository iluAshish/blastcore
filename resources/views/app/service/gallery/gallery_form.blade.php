                ...
                <div class="col-lg-6">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ url('admin/service/gallery/'. (isset($gallery) ? $gallery->service->id : $service->id)) }}">
                                {{ isset($gallery) ? $gallery->service->title : $service->title }} Gallery
                            </a>
                        </li>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="h3">{{ $key }} Gallery Images
                            - {{ isset($gallery) ? $gallery->service->title : $service->title }}</h3>
                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="hidden" name="service_id" id="service_id"
                                           value="{{ isset($gallery) ? $gallery->service->id : $service->id }}">
